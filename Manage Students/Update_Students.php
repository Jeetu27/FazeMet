        ...
        <form action="code.php" method="POST">
            ...
            <div class="details">
                ...
                <div class="fields">
                    ...
                    <input type="number" name="st_Id" value="<?=$getdata['Student ID'];?>" placeholder="Enter Student's ID Number" required>
                </div>
                ...
                <div class="fields">
                    <label>Course</label>
                    <input type="text" value="<?=$getdata['Course'];?>" name="course" placeholder="Enter course details" required>
                </div>
            ...
            <div class="buttons">
                <button class="back" name="back">
                    <a style="color: #fff; text-decoration: none;" class="btnText" href="Manage Students.php">Back</a>
                </button>
